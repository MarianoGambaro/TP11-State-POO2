...
public class EstadoEsperandoSuma implements EstadoCalculadora {


    @Override
    public void valor(Calculadora calc, double unValor) {
        calc.nuevoValorAcumulado(calc.valorAcumulado() + unValor);
        calc.nuevoEstado(new EstadoInicial()); //y vuelve al estado inicial
    }
    ...
    public String toString() {
        return "ESTADO: Esperando Operando (Suma)";
    }
}
